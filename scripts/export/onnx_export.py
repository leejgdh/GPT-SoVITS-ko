...
hubert_base_path = os.environ.get(
...
if __name__ == "__main__":
    ...
    parser = argparse.ArgumentParser(description="ONNX export for GPT-SoVITS")
    parser.add_argument("--gpt_path", required=True, help="Path to GPT model checkpoint")
    parser.add_argument("--vits_path", required=True, help="Path to SoVITS model weights")
    parser.add_argument("--exp_name", required=True, help="Export project name")
    ...
    export(args.vits_path, args.gpt_path, args.exp_name)
